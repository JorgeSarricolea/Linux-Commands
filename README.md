...
| sudo <command with options> | run a command with root privileges; For it to work it is necessary to enter the password of the current user | kant@kant:/etc/ sudo cp fstab fstab~   [sudo] password for kant: |
